...
for test in test_submconv3d.py test_build_subm_map.py test_ptv3_cpe.py test_cpe_postops.py test_grid_encode.py test_ptv3_grid_encode.py test_performance.py; do
